...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('auto_max_training_samples', default_value='15', description='Legacy option; automatic acquisition uses six initial plus nine targeted samples'),
